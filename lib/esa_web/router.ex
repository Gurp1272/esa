defmodule EsaWeb.Router do
  ...
  scope "/", EsaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{EsaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", EsaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{EsaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", EsaWeb do
    ...
    live_session :current_user,
      on_mount: [{EsaWeb.UserAuth, :mount_current_user}] do
